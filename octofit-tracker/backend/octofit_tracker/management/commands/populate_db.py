...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        heroes = [
            ...
            {'username': 'barry_allen', 'email': 'barry@S.T.A.R.Labs', 'first_name': 'Barry', 'last_name': 'Allen', 'bio': 'Speedster with super fast recovery.', 'age': 29, 'weight': 85.0, 'height': 191, 'fitness_goals': 'Keep speed and endurance high'},
        ]
        ...
        for hero in heroes:
            ...
            users.append(user)
            self.stdout.write(f'Created user and profile: {hero["username"]}')
        ...
        activity_options = ['Flying', 'Speed Training', 'Martial Arts', 'Strength Training', 'Parkour', 'Shield Practice', 'Advanced Combat']
        ...
        for user in users:
            for index in range(6):
                Activity.objects.create(
                    ...
                    calories_burned=random.randint(250, 750),
                    date=base_date + timedelta(days=index * 2),
